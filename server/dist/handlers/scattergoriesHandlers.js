...
exports.registerScattergoriesHandlers = registerScattergoriesHandlers;
exports.startRound = startRound;
const timerRegistry_1 = require("./timerRegistry");
function registerScattergoriesHandlers(socket, io) {
...
function startRound(roomCode, io) {
    ...
    (0, timerRegistry_1.registerRoomTimer)(roomCode, timerInterval);
}
