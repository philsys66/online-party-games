...
export const MONOPOLY_BOARD: BoardSpace[] = [
    ...
    { id: 1, name: "Substack", type: 'property', price: 60, rent: [2, 10, 30, 90, 160, 250], group: 'brown', houseCost: 50, mortgageValue: 30 },
    { id: 2, name: "Wikipedia", type: 'action' },
    { id: 3, name: "Patreon", type: 'property', price: 60, rent: [4, 20, 60, 180, 320, 450], group: 'brown', houseCost: 50, mortgageValue: 30 },
    ...
    { id: 6, name: "Snapchat", type: 'property', price: 100, rent: [6, 30, 90, 270, 400, 550], group: 'lightblue', houseCost: 50, mortgageValue: 50 },
    { id: 7, name: "Venture Capitalist", type: 'action' },
    { id: 8, name: "Pinterest", type: 'property', price: 100, rent: [6, 30, 90, 270, 400, 550], group: 'lightblue', houseCost: 50, mortgageValue: 50 },
    { id: 9, name: "Reddit", type: 'property', price: 120, rent: [8, 40, 100, 300, 450, 600], group: 'lightblue', houseCost: 50, mortgageValue: 60 },
    { id: 10, name: "Jail", type: 'jail' },
    { id: 11, name: "Spotify", type: 'property', price: 140, rent: [10, 50, 150, 450, 625, 750], group: 'pink', houseCost: 100, mortgageValue: 70 },
    { id: 12, name: "Starlink", type: 'utility', price: 150, group: 'utility', mortgageValue: 75 },
    { id: 13, name: "Netflix", type: 'property', price: 140, rent: [10, 50, 150, 450, 625, 750], group: 'pink', houseCost: 100, mortgageValue: 70 },
    { id: 14, name: "Disney+", type: 'property', price: 160, rent: [12, 60, 180, 500, 700, 900], group: 'pink', houseCost: 100, mortgageValue: 80 },
    { id: 15, name: "Google Cloud", type: 'railroad', price: 200, rent: [25, 50, 100, 200], group: 'railroad', mortgageValue: 100 },
    { id: 16, name: "Uber", type: 'property', price: 180, rent: [14, 70, 200, 550, 750, 950], group: 'orange', houseCost: 100, mortgageValue: 90 },
    { id: 17, name: "Wikipedia", type: 'action' },
    { id: 18, name: "Airbnb", type: 'property', price: 180, rent: [14, 70, 200, 550, 750, 950], group: 'orange', houseCost: 100, mortgageValue: 90 },
    { id: 19, name: "WeWork", type: 'property', price: 200, rent: [16, 80, 220, 600, 800, 1000], group: 'orange', houseCost: 100, mortgageValue: 100 },
    { id: 20, name: "Server Crash (Free Parking)", type: 'parking' },
    { id: 21, name: "TikTok", type: 'property', price: 220, rent: [18, 90, 250, 700, 875, 1050], group: 'red', houseCost: 150, mortgageValue: 110 },
    { id: 22, name: "Venture Capitalist", type: 'action' },
    { id: 23, name: "Instagram", type: 'property', price: 220, rent: [18, 90, 250, 700, 875, 1050], group: 'red', houseCost: 150, mortgageValue: 110 },
    { id: 24, name: "YouTube", type: 'property', price: 240, rent: [20, 100, 300, 750, 925, 1100], group: 'red', houseCost: 150, mortgageValue: 120 },
    { id: 25, name: "Azure Region", type: 'railroad', price: 200, rent: [25, 50, 100, 200], group: 'railroad', mortgageValue: 100 },
    { id: 26, name: "X (Twitter)", type: 'property', price: 260, rent: [22, 110, 330, 800, 975, 1150], group: 'yellow', houseCost: 150, mortgageValue: 130 },
    { id: 27, name: "LinkedIn", type: 'property', price: 260, rent: [22, 110, 330, 800, 975, 1150], group: 'yellow', houseCost: 150, mortgageValue: 130 },
    { id: 28, name: "GPU Cluster", type: 'utility', price: 150, group: 'utility', mortgageValue: 75 },
    { id: 29, name: "Discord", type: 'property', price: 280, rent: [24, 120, 360, 850, 1025, 1200], group: 'yellow', houseCost: 150, mortgageValue: 140 },
    { id: 30, name: "Go To Jail", type: 'gotojail' },
    { id: 31, name: "Stripe", type: 'property', price: 300, rent: [26, 130, 390, 900, 1100, 1275], group: 'green', houseCost: 200, mortgageValue: 150 },
    { id: 32, name: "SpaceX", type: 'property', price: 300, rent: [26, 130, 390, 900, 1100, 1275], group: 'green', houseCost: 200, mortgageValue: 150 },
    { id: 33, name: "Wikipedia", type: 'action' },
    { id: 34, name: "OpenAI", type: 'property', price: 320, rent: [28, 150, 450, 1000, 1200, 1400], group: 'green', houseCost: 200, mortgageValue: 160 },
    ...
    { id: 37, name: "Nvidia", type: 'property', price: 350, rent: [35, 175, 500, 1100, 1300, 1500], group: 'darkblue', houseCost: 200, mortgageValue: 175 },
    { id: 38, name: "GDPR Fine", type: 'tax', price: 100 },
    { id: 39, name: "Apple", type: 'property', price: 400, rent: [50, 200, 600, 1400, 1700, 2000], group: 'darkblue', houseCost: 200, mortgageValue: 200 }
];
